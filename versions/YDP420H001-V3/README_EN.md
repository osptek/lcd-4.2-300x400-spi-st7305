...
<p align="center"><b>LCD module · SPI · ST7305</b></p>
...
<p align="center"><img alt="OSPTEK 4.2 inch 300×400 LCD SPI module (ST7305) product image" src="./images/product.png" width="640" /></p>
...
OSPTEK **4.2″ 300×400 LCD** is a **SPI** display module driven by **ST7305**.

Spec ID (repository name): `lcd-4.2-300x400-spi-st7305`

Current module version: **YDP420H001-V3**. Electrical and mechanical details follow [`docs/YDP420H001-V3.pdf`](./docs/YDP420H001-V3.pdf).
...
└── versions/
    └── YDP420H001-V3/                      # full materials for this part number
        ├── README.md
        ├── README_EN.md
        ├── images/
        ├── docs/
...
| Resource | Link |
| ---- | ---- |
| Product datasheet (YDP420H001-V3) | [`docs/YDP420H001-V3.pdf`](./docs/YDP420H001-V3.pdf) |
